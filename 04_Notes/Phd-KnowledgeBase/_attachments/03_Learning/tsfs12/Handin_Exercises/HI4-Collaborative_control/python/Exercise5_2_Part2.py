...
# This is different from Part1, here you need to redefine the idx as the relative measurement between Agent 2--8 changed
measurement_graph = [
    agent_idx[0],  # Agent 1
    np.dstack(
        (
...
# You need to redefine the reference between each pair of agents
