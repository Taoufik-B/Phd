classdef MotionPrimitives < handle
    ...
    methods
        ...
        function [p, sp] = plan_to_path(obj, start, plan)
            ...
            % primitives specified by the plan. 
            % 
            % Input:
            %   start is the coordinates of the start state (x, y, theta)
            %   plan is the full output from the planner. 
            %
            % Outputs:
            %   The output sp describes which parts of
